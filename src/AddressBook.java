...
public class AddressBook {
    ...
    public static void Delete() {
        Scanner sc = new Scanner(System.in);
        String telefono;
        System.out.println("Cuál es el telefono del contacto que desea borrar?");
        telefono = sc.nextLine();
